...
export default function NewsletterActions({ url }: NewsletterActionsProps) {
  ...
  // Visualizar PDF no navegador externo (força sair do app)
  const handleView = () => {
    setLoading(true);
    ...
    // Força sair do app e abrir no navegador/app externo
    window.location.href = viewUrl;
  };

  // Forçar Download do PDF (sai do app e abre em app nativo)
